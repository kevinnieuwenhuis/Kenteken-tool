...
def generate_pdf(kenteken, bouwjaar, datum_tenaamstelling, cataloguswaarde, bijtelling, berekening_info, btw_correctie, btw_info):
    ...
    if btw_correctie is not None:
        ...
        c.drawString(50, 630, "BTW-correctie: Kan niet berekend worden (geen datum laatste tenaamstelling)")
...
def add_background(logo_path):
    ...
    /* Zorg dat alle standaardtekst zwart wordt */
    .stMarkdown, .stRadio, .stTextInput, .stSelectbox, .stButton, .stDownloadButton, .stAlert {{
        color: black !important;
    }}
