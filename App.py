...
def calculate_btw_correction(cataloguswaarde, is_btw_auto, bouwjaar, jaar):
    leeftijd_auto = int(jaar) - bouwjaar
    if not is_btw_auto or leeftijd_auto > 5:
        return cataloguswaarde * 0.015, "1,5% over cataloguswaarde (marge auto of ouder dan 5 jaar)"
    return cataloguswaarde * 0.027, "2,7% over cataloguswaarde (btw-auto)"
