...
def calculate_bijtelling(cataloguswaarde, dga_of_ib, bouwjaar, jaar, datum_tenaamstelling, youngtimer_waarde=None):
    ...
    if leeftijd_auto >= 15:  # Youngtimer
...
def add_background(logo_path):
    ...
    /* Algemene tekst en labels: zwart */
    ...
    /* Radiokeuzes en dropdownopties */
    .css-1cpxqw2, .css-1fv8s86 {{
        color: black !important;
    }}

    /* Knoppen zwart op grijs */
    ...
    /* Titels standaard zwart */
    h1, h2, h3, h4, h5, h6 {{
        color: black !important;
    }}

    /* Meldingsblokken (alle types): witte tekst op donkere achtergrond */
    .stAlert div {{
