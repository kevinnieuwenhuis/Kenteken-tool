...
def add_background(logo_path):
    ...
    .stApp {{
        ...
        background-image: url('data:image/jpg;base64,{encoded_logo}');
        background-size: cover;
        background-position: center;
        background-repeat: no-repeat;
    }}
    /* Alleen tekst in labels, titels, knoppen en radio's zwart maken */
    ...
    /* Tekst in invoervelden wit houden en achtergrond donkerder maken */
    .stTextInput input,
    ...
    /* Witte tekst voor meldingsvakken */
    .stAlert div {
        color: white !important;
    }
    ::placeholder {
